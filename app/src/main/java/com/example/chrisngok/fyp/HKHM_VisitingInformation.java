...
public class HKHM_VisitingInformation extends BaseActivity {
    String startLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        website1.setText(R.string.hkhm_website1);
    }
