...
public class HKMOH_TransportActivity extends BaseActivity {
    String startLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (startLang.equals("en")) {
            imageView.setImageResource(R.drawable.hkmoh_map_eng);
        } else if (startLang.equals("zh") || startLang.equals("cn")) {
            imageView.setImageResource(R.drawable.hkmoh_map_chi);
        }
        ...
        button_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String uri = "http://maps.google.com/maps?daddr=" + 22.301987 + "," + 114.177352;
