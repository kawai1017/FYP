...
public class HKSM_TransportActivity extends BaseActivity {
    String startLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (startLang.equals("en") ) {
            imageView.setImageResource(R.drawable.hksm_map_eng);
        } else if (startLang.equals("zh") || startLang.equals("cn")) {
            imageView.setImageResource(R.drawable.hksm_map_chi);
        }
