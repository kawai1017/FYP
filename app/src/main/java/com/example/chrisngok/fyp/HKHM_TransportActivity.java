...
public class HKHM_TransportActivity extends BaseActivity {
    String startLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (startLang.equals("en") ) {
            imageView.setImageResource(R.drawable.hkhm_map_eng);
        } else if (startLang.equals("zh") || startLang.equals("cn")) {
            imageView.setImageResource(R.drawable.hkhm_map_chi);
        }
        ...
        button_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String uri = "http://maps.google.com/maps?q=Hong Kong Heritage Museum";
